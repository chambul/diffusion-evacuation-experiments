 ...
 */
public class SocialNetworkExperiments50kBaselineTestIT {

    // have tests in separate classes so that they run, at least under maven, in separate JVMs.  kai, nov'17

    private static final Logger log = LoggerFactory.getLogger(SocialNetworkExperiments50kBaselineTestIT.class);
    ...
    public void testSocialNetwork50kBaseline() {
        ...
        utils.setTestClassAndMethod(this.getClass(), "testSocialNetwork50kBaseline"); // set test class and method name
