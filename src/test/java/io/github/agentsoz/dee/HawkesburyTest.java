...
public class HawkesburyTest {

    // have tests in separate classes so that they run, at least under maven, in separate JVMs.  kai, nov'17

    private static final Logger log = LoggerFactory.getLogger(HawkesburyTest.class);
...
//        Global.setRandomSeed(4711); // deterministic results for testing
        ...
        String[] args = {
                "--config", "scenarios/hawkesbury/social_network_experiments_diffusion.xml",
        };
        Main.main(args);
