 ...
 */
public class SocialNetworkExperiments50kDiffusionTestIT {

    // have tests in separate classes so that they run, at least under maven, in separate JVMs.  kai, nov'17

    private static final Logger log = LoggerFactory.getLogger(SocialNetworkExperiments50kDiffusionTestIT.class);
